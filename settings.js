...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=3Mt2FC4Q#ZnRkByOO1xFjUnSDFlm5efETXjWBj4LCGmeJhJU0drU' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '+923452401207' : process.env.OWNER_NUMBER,   
...
WORK_TYPE: process.env.WORK_TYPE || 'publice' ,
